 ...
 (deftest should-handle-edge-cases
   (testing "should handle edge cases properly"
     ...
     (is (= 42 (y/parse-number "042")))
     (is (= 7 (y/parse-number "007")))
     (is (= 0.5 (y/parse-number "00.5")))
     (is (= -12 (y/parse-number "-0012")))
     (is (= -12.5 (y/parse-number "-0012.5")))))
